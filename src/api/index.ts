...
export const getData: () => IBook[] = () => [
  ...
  },
  {
    ...
    Культовый сетевой роман Дмитрия Глуховского уже известен ста тысячам интернет-пользователей. Выхода этой книги ждали все.`,
    year: 2005
  },
  {
    id: nanoid(),
    name: 'Война и мир',
    description: `Величайшая эпопея, снискавшая славу во всем мире. Сотни героев, застигнутых безжалостным потоком времени, и сотни судеб, перемолотых масштабными историческими событиями.
